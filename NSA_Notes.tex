...
% chktex-file 8 % this line tells ChkTeX to ignore warning number 8 throughout the file, which prevents the "Wrong length of dash may have been used" warning from appearing.

\title{Neural Signal Analysis - Notes}
\author{Gaia Burlando, Letizia Cerutti, Simone Migliazza, Francesco Negri}
\date{A.Y. 2024-2025}
...
\section{Course Info}
\input{sections/0_course_info.tex}
\newpage
...
\section{Graph Theory and Critical Brain Hypothesis}
